...
from app.api import routes_contratante, routes_endereco, routes_questionario, routes_hobbies, routes_cuidador, routes_questionario_cuidador, routes_hobbies_cuidador, routes_usuario
